...
5. **Material Safety Data Sheets and Standard Operating Procedures** - MSDSs and SOPs for all chemicals stored in the lab can be found in the pre-PCR lab, on the shelf above the lab bench on the south wall (MAR 272).
...
Expsoure limits for hazardous materials can be found on their MSDSs, stored in the pre-PCR lab above the lab bench on the south wall (MAR 272).

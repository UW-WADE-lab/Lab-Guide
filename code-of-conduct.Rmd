...
If _any_ inappropriate behavior persists after a discussion with Amy, the offender will be asked to discontinue their participation in W.A.D.E. lab projects, meetings, or other activities.

## Reporting

If you believe someone has violated the Code of Conduct, please report it to Amy who will take appropriate action to address the situation. If the incident involves Amy, or for whatever reason you are uncomfortable reporting the incident to Amy, please contact any of the following individuals:
...
This content is based upon the Code of Conduct developed by [Mark Scheuerell](https://fish.uw.edu/faculty/mark-scheuerell/) and the [Applied Ecology Lab](https://depts.washington.edu/appliedecology/), as well as the [Data Carpentries](https://docs.carpentries.org/topic_folders/policies/code-of-conduct.html#about-this-document) Codes of Conduct.
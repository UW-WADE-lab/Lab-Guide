...
5. **Material Safety Data Sheets and Standard Operating Procedures** - MSDSs and SOPs for all chemicals stored in the lab can be found in MAR 276, on the shelf above the lab bench on the south wall.
...
Expsoure limits for hazardous materials can be found on their MSDSs, stored in MAR 276 above the lab bench on the south wall.
...
Nitrile gloves can be found in MAR 271 by the door, in MAR 276 by the south door, and in MAR 277 by XXXX.

### Equipment Safety

Proper technique is important to ensure safety while using MERLab equipment. Special considerations include:
...
1. **EtOH (ethanol)** is stored in MAR 276, in the chemical cabinet underneath the fume hood located at the north end of the room. 
...
1. MAR271:
2. MAR276: along north wall of the lab.
3. MAR277: 
...
The MERLab is divided into three main areas to minimize contamination: (1) a DNA extraction lab (MAR 271), (2) a pre-PCR lab (MAR 276), and (3) a post-PCR lab (MAR 277). Genetic material should only move in the direction 1-2-3 and never backwards. Once genetic material has left the pre-PCR lab, for example, it can only go to the post-PCR lab and never return to the DNA extraction lab or pre-PCR lab.
...
1. DNA Extraction
2. PCR amplification
3. Metabarcoding library prepartion
